...
const ProductCard = ({item} ) =>{
    return(
        <div className="flex flex-col justify-between items-center bg-white rounded-lg shadow-lg p-4 m-4 w-72  hover:scale-105 transition-transform duration-300 ease-in-out">
            <div>
